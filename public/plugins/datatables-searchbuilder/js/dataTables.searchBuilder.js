...
(function () {
    ...
    var Criteria = /** @class */ (function () {
        ...
        /**
         * Escape htmllar characters within a string
         *
        ...
        Criteria.initSelect = function (that, fn, preDefined, array) {
            ...
            for (var _i = 0, indexArray_1 = indexArray; _i < indexArray_1.length; _i++) {
                ...
                var addOption = function (filt, text) {
                    ...
                    // Add text and value, stripping out any htmllar if that is the column type
                    var opt = $$2('<option>', {
                        ...
                        // Have to add the text this way so that special htmllar characters are not escaped - &amp; etc.
