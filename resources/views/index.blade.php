...
@section('home_section')
    <div class="hero-section">
        <div class="container text-center wow zoomIn">
            <span class="subhead">Keling hayotinggizni baxtiyor qilaylik</span>
            <h1 class="display-4">Sog'lom Turmush Tarzi</h1>
            <a href="#" class="btn btn-primary">Maslahat Oling</a>
        </div>
    </div>
@endsection
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 py-3 py-md-0">
                        <div class="card-service wow fadeInUp">
                            ...
                            <p><span>One</span>-Health Himoyasi</p>
                        </div>
                    </div>
                    <div class="col-md-4 py-3 py-md-0">
                        <div class="card-service wow fadeInUp">
                            ...
                            <p><span>One</span>-Health Dorixonalari</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                @foreach($sliders as $slider)
                    <div class="item">
                        <div class="card-doctor">
                            ...
                            <div class="body">
                                <p class="text-xl mb-0">Dr. {{$slider->name}}</p>
                                <span class="text-sm text-grey">{{$slider->job}}</span>
                            </div>
                        </div>
                    </div>
                @endforeach
